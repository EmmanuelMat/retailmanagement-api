    ...
    <Card className="max-w-4xl">
      <CardContent className="pt-5">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <p className="text-xs text-muted-foreground -mt-3">Límite de crédito: máximo que este cliente puede deber a la vez en ventas fiadas. Déjalo en 0 si no vende fiado a este cliente.</p>
