      ...
      <div className="mx-auto max-w-[1200px]">
        <div className="rounded-[20px] border-[3px] border-black bg-white text-black p-8 shadow-[8px_8px_0px_black]">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-black text-[22px] tracking-tight">Devoluciones • Notas Crédito E34</h1>
              <p className="text-[12px] font-bold opacity-60 mt-1">Referencia E31/E32 original via InformacionReferencia, motivo</p>
            </div>
          </div>
